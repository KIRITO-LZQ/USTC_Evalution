...
public class GroupServiceImpl implements GroupService {
    ...
    public String createGroup(String groupName, TUser tUser) {
        ...
        //因为改了tUser的userId类型，所以要做一个类型转换
//        Integer masterId=Integer.valueOf(tUser.getUserId());
    ...
    @Override
    public void countNumber(StatisPerson statisPerson,String groupNum){
        statisPerson.setSix(groupMapper.countByValue(groupNum,6));
        statisPerson.setFive(groupMapper.countByValue(groupNum,5));
        statisPerson.setFour(groupMapper.countByValue(groupNum,4));
        statisPerson.setThree(groupMapper.countByValue(groupNum,3));
        statisPerson.setTwo(groupMapper.countByValue(groupNum,2));
        statisPerson.setOne(groupMapper.countByValue(groupNum,1));
