...
public class MessageServiceImpl implements MessageService {
    ...
    public void sendAddFriendMessageOneToOne(ChatEndPoint chatEndPoint, Message message) {
        ...
        String unreadMessageId=numUtils.getNumStringByCounts(5);
        System.out.println(unreadMessageId);
        unreadMessage.setId(Integer.valueOf(unreadMessageId));
    ...
    public void sendMessageOneToGroup(ChatEndPoint chatEndPoint, Message message) {
        ...
        //获取发送此消息的成员的昵称，如果群备注为空则显示昵称（在这里就是姓名）
    ...
    public void sendMessageOneToOne(ChatEndPoint chatEndPoint, Message message) {
        String fromUserNum = (String)chatEndPoint.getHttpSession().getAttribute("userNum");
        Integer fromUserId = (Integer) chatEndPoint.getHttpSession().getAttribute("curUserId");
//        Enumeration enumeration = chatEndPoint.getHttpSession().getAttributeNames();
//        while (enumeration.hasMoreElements()){
//            String name = enumeration.nextElement().toString();
//            Object value = chatEndPoint.getHttpSession().getAttribute(name);
//            System.out.println(name+":"+value);
//        }
//        获取到的属性值包括
//        curUserId:36606
//        userNum:2
//        curUser:com.ctgu.j604.springbootchat.model.TUser@75714773
//        status:on
        String toUserNum = message.getToUserNum();
    ...
    @Override
//   实现表情的插入
    public void sendEnjoy(ChatEndPoint chatEndPoint, Enjoy enjoy){
        String fromUserNum = (String)chatEndPoint.getHttpSession().getAttribute("userNum");
        Integer fromUserId = (Integer) chatEndPoint.getHttpSession().getAttribute("curUserId");

//        NumUtils numUtils=new NumUtils();
//        String id=numUtils.getNumStringByCounts(3);
//        enjoy.setId(Integer.valueOf(id));
        enjoy.setStuId(fromUserId);
        enjoy.setStuNum(fromUserNum);

        Enjoy result=enjoyMapper.queryExist(enjoy.getStuId(),enjoy.getGroupNum());
        if(result==null){
            enjoyMapper.insert(enjoy);
        }else{
//            System.out.println("1");
            enjoyMapper.update(result.getId(),enjoy.getValue(),enjoy.getSendTime());
