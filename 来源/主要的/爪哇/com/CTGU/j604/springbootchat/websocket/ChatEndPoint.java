        ...
        try{
            ...
            switch (msgTypeCode){
                case 1:{
                    ...
                    enjoy.setValue(Integer.valueOf(message1.getMessage()));
                    enjoy.setsendTime(message1.getSendTime());
                    enjoy.setGroupNum(message1.getToUserNum());
                    messageService.sendEnjoy(this,enjoy);
                }break;
                case 2:{
